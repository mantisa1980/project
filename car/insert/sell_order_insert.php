...
// create order 
$stmt = mysqli_prepare($link, "INSERT INTO sell_order(`paid`, `created_on`, `note`, `customer_id`) VALUES (0,NOW(),?,?)");
...
foreach($json_data as $d)
{
	...
	$stmt = mysqli_prepare($link, "INSERT INTO sell_order_item(`order_id`,`item_id`,`unit_id`,`unit_amount`,`final_per_unit_price`) VALUES (?,?,?,?,?)");
